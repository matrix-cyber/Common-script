...
class ADSL_by_Lan:
    ...
    def ADD(self): #添加
        ...
        time.sleep(3)
        self.find_element(self.ElementCss["ID"]).send_keys(self.TestData["ID"])
        ...
        time.sleep(2)
        try:
            self.find_element(self.ElementCss["ID"])
            self.bool = True
    ...
    def EDIT_DefaultRoute(self): #编辑WAN1的默认路由
